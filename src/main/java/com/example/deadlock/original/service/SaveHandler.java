...
public class SaveHandler {
    ...
    @Transactional
    void extracted(final BaseEntity base, final List<Doo> dooAllList, final RootEntity rootEntity, final List<LongTransactionService.JoDoo> joDooList, final List<Foo> fooList) {
